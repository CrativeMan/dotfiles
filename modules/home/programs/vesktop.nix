{vars, ...}: {
  home.file."/home/${vars.user}/.config/vesktop/themes/midnight-rose-pine.theme.css" = {
    text = ''
      /**
      ...
      */
      ...
      body {
          ...
          --background-image-url: url("https://raw.githubusercontent.com/CrativeMan/dotfiles/refs/heads/master/assets/wallpapers/flatppuccin_4k_macchiato.png"); /* url of the background image */
          ...
          --blur-amount: 2px; /* amount of blur */
          --bg-floating: var(
              --bg-3
